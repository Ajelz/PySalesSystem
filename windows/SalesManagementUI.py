from PyQt5.QtWidgets import QWidget, QVBoxLayout, QPushButton, QTableWidget, QTableWidgetItem, QLabel, QHBoxLayout
from PyQt5.QtCore import Qt
from functions.balance_functions import get_balance

class SalesManagementUI(QWidget):
    def __init__(self):
        super().__init__()
        ...
        self.balanceLabel = QLabel(f"Balance: ${get_balance():.2f}")  # Display the balance on GUI
